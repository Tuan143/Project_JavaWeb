...
public class SearchProductController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int pageSize = 4;
            int totalProduct = iProduct.countTotalProductByTextSearchAndCategoryId(txtSearch, categoryId);
            ...
            ArrayList<Product> listProduct = iProduct.searchProduct(txtSearch, categoryId, 1, 4);
            ...
            request.setAttribute("categoryId", categoryId); // Để biết khi nào xuất hiện back
            request.setAttribute("textSearch", txtSearch); // Để biết khi nào xuất hiện back
